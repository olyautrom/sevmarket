! function(e) {
    e.fn.imageUploader = function(t) {
        let n, i = {
                ...
                label: "Перетащите сюда изображения или кликните для выбора",
        ...
        let o = function() {
            ...
            p = function(t) {
                ...
                let i = e(this),
                    ...
                    l = [];
                t.target.classList.remove('start');
    ...
    if (form) {
        var button = form.querySelector('button:last-of-type');

        if (button) {
            button.addEventListener('click', function() {
                var uploaders = Array.prototype.slice.call(form.querySelectorAll('.image-uploader'));

                uploaders.forEach(function(uploader) {
                    var input = uploader.querySelector('input[type="file"]');
                    var preloaded = uploader.querySelector('input[type="hidden"]');

                    input.classList.remove('start');

                    if (preloaded && preloaded.value) {
